...
export function TestCallDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent
        className="max-h-[calc(100dvh-2rem)] max-w-md overflow-hidden rounded-2xl p-0"
        style={{ fontFamily: "'Switzer', sans-serif" }}
      >
        <div className="flex max-h-[calc(100dvh-2rem)] min-h-0 flex-col">
          <DialogHeader className="shrink-0 px-5 pb-3 pt-5">
            <p className="label-caps">Voice demo</p>
            <DialogTitle className="text-[18px] font-semibold text-foreground">
              Hear the sales receptionist
            </DialogTitle>
            <p className="text-[12px] leading-relaxed text-muted-foreground">
              Run a live demo to your own phone or a sandbox line.
            </p>
          </DialogHeader>
          ...
          {result ? (
            <div className="flex flex-col items-center gap-3 px-5 pb-6 pt-3">
              ...
              <div className="text-center">
                ...
                <p className="mt-1 font-mono text-[11px] text-[color:var(--subtle)]">
                  {result.callId}
                </p>
              </div>
            ...
            <>
                ...
                <div className="space-y-3.5">
                      ...
                      {demoScenarios.map((scenario) => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "min-h-12 rounded-lg border px-2 py-2 text-center text-[11.5px] font-semibold leading-tight transition-colors",
                              active
                                ? "border-foreground bg-[color:var(--elevated)] text-foreground"
                                : "border-border bg-surface text-muted-foreground hover:bg-[color:var(--elevated)] hover:text-foreground"
                            )}
                          >
                            {scenario.label}
                          </button>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      className="h-10 px-3 font-mono text-[14px] tabular-nums focus-visible:ring-2"
                      autoFocus
                      onKeyDown={(e) => {
                    ...
                    {phoneTouched && phoneValid && normalized !== phone.trim() ? (
                      ...
                      <p className="text-[11.5px] text-[#9A6619]">
                        Add country code, e.g.{" "}
                        <span className="font-mono">
                          +1{phone.replace(/\D/g, "").slice(0, 10) || "5551234567"}
                        </span>
                      </p>
                    ) : (
                      <p className="text-[11.5px] text-muted-foreground">
                        10-digit US numbers auto-prefix with +1.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-10 px-3 text-[13px] focus-visible:ring-2"
                      />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <label className="flex cursor-pointer items-start gap-2.5 rounded-lg border border-border bg-[color:var(--elevated)] px-3 py-2.5 text-[12.5px]">
                    <input
                      type="checkbox"
                      checked={skipDnc}
                    ...
                    <span className="text-foreground">
                      ...
                      <span className="mt-0.5 block text-[11px] text-muted-foreground">
                        Use this only for your own phone or test line.
                      </span>
                    </span>
                  </label>
                  ...
                  {outsideHours && (
                    ...
                    >
                      ...
                      <span>
                        Outside TCPA hours (8 AM – 9 PM local). Compliance flags may fire.
                      </span>
                    </div>
                  )}
                  ...
                  >
                    ...
                    <span>The rep identifies as AI naturally and offers an opt-out.</span>
                  </div>
              ...
              <div className="flex shrink-0 gap-2 border-t border-hairline bg-surface px-5 py-3">
